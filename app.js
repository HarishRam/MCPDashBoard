...
app.use(require('./routers/changes'));
app.use(require('./routers/jiradata'));
app.use(require('./routers/planner'));

app.get('/', function(req, res, next){
    res.send("Hello to Device Cert Dashboard, please visit https://github.com/bbc/TV-Certification-Dashboard#readme");
});
